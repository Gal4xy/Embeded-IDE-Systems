...
class DebuggerMISession extends MISession
{
  int m_launchTimeout;
  private MITargetDownload download;

  public DebuggerMISession(MIProcess process, IMITTY pty, int commandTimeout, int type, int launchTimeout, String ip)
    throws MIException
  {
