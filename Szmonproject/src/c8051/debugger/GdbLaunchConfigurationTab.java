...
import c8051.debugger.c51debugger;
...
public class GdbLaunchConfigurationTab extends CDebuggerTab {
	...
	protected void loadDebuggerComboBox(ILaunchConfiguration config,
		...
		String defaultSelection = c51debugger.DEBUGGER_ID;
		for (int i = 0; i < debugConfigs.length; ++i) {
			...
			if (id.contains(c51debugger.DEBUGGER_ID))
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy config) {
		...
		// }
		 ...
		 String symbol = null;
		 String gdbCommand = c51debugger.DEBUGGER_CMD;
		 ...
		 gdbCommand);
		 config.setAttribute(Constants.ATTR_DEBUG_NAME, gdbCommand);
