...
public abstract interface SparcElfConstants
{
  public static final String GDB_COMMAND = "sparc-elf-gdb";
  public static final String ATTR_TSIM_TYPE = MIPlugin.getUniqueIdentifier() + ".sparcelf.TSIMTYPE";
  ...
  public static final String ATTR_TSIM_TTY = MIPlugin.getUniqueIdentifier() + ".sparcelf.TSIMTTY";
  public static final String ATTR_TSIM_BAUD = MIPlugin.getUniqueIdentifier() + ".sparcelf.TSIMBAUD";
