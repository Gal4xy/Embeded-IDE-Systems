...
public class SparcElfGDBDebugger extends GDBCDIDebugger {

	public static final String DEBUGGER_ID = SparcElfGDBDebugger.class.getName();
	  public static final String DEBUGGER_CMD= "sparc-elf-gdb";
	/**
 * 
 * @return
	 * @throws CoreException 
 */
public Session createLaunchSession(ILaunchConfiguration config,IBinaryParser.IBinaryObject exe,
