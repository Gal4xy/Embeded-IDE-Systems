...
public class SparcElfGDBDebugger4 extends GDBCDIDebugger
{
  public static final String DEBUGGER_ID = SparcElfGDBDebugger4.class.getName();
  public static final String DEBUGGER_CMD ="tic3x-gdb.exe";
