...
public class SparcElfGDBDebugger3 extends GDBCDIDebugger
{
  public static final String DEBUGGER_ID = SparcElfGDBDebugger3.class.getName();
  public static final String DEBUGGER_CMD = "tic6713-gdb.exe";
