...
public class SparcElfGDBDebugger2 extends GDBCDIDebugger
{
  public static final String DEBUGGER_ID = SparcElfGDBDebugger2.class.getName();
  public static final String DEBUGGER_CMD = "tic6416-gdb.exe";
