...
public class SparcElfGDBDebuggerPage5 extends AbstractLaunchConfigurationTab
		implements Observer {
	...
	public SparcElfGDBDebuggerPage5() {
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			...
			gdbCommand = configuration.getAttribute(
					SparcElfConstants.ATTR_DEBUG_NAME, "vc33-gdb");
