...
public class SparcElfSession
{
  ...
  public String substituteSpace(String s) {
    int compareInt = Platform.getOS().compareTo("win32");//modified by  lichengfei 2012-08-28

    return s; 
  }

  public void RtemsMISession()
  {
  }

  public SparcElfMiSession createMISession(MIProcess process, IMITTY pty, int commandTimeout, int type, int launchTimeout, String ip)
    throws MIException
  {
    return new SparcElfMiSession(process, pty, commandTimeout, type, launchTimeout, ip);
  }

  public SparcElfMiSession createMISession(MIProcess process, IMITTY pty, int type, String ip)
    throws MIException
  {
...
//    Thread syncStartup = new SparcElfSession.1(this, "GDB Start", pgdb);
